...
public abstract class LabelledAbstractResetInhibitorNet extends AbstractDirectedGraph<PetrinetNode, PetrinetEdge<? extends PetrinetNode, ? extends PetrinetNode>>{
	...
	public LabelledAbstractResetInhibitorNet(boolean allowsReset, boolean allowsInhibitors) {
		super();
		transitions = new LinkedHashSet<LabelledTransition>();
	...
	public synchronized ResetArc addResetArc(Place p, LabelledTransition t) {
		return addResetArc(p, t, null, null);
	}

	public synchronized ResetArc addResetArc(Place p, LabelledTransition t, ExpandableSubNet parent) {
		return addResetArc(p, t, null, parent);
	}

	public synchronized ResetArc addResetArc(Place p, LabelledTransition t, String label) {
		return addResetArc(p, t, label, null);
	}

	public synchronized ResetArc addResetArc(Place p, LabelledTransition t, String label, ExpandableSubNet parent) {
		checkAddEdge(p, t);
	...
	public synchronized ResetArc removeResetArc(Place p, LabelledTransition t) {
		return removeFromEdges(p, t, resetArcs);
	}

	public synchronized InhibitorArc addInhibitorArc(Place p, LabelledTransition t, String label) {
		return addInhibitorArc(p, t, label, null);
	}

	public synchronized InhibitorArc addInhibitorArc(Place p, LabelledTransition t, String label, ExpandableSubNet parent) {
		checkAddEdge(p, t);
	...
	public synchronized InhibitorArc addInhibitorArc(Place p, LabelledTransition t) {
		return addInhibitorArc(p, t, null, null);
	}

	public synchronized InhibitorArc addInhibitorArc(Place p, LabelledTransition t, ExpandableSubNet parent) {
		return addInhibitorArc(p, t, null, parent);
	}

	public synchronized InhibitorArc removeInhibitorArc(Place p, LabelledTransition t) {
		return removeFromEdges(p, t, inhibitorArcs);
	}

	public synchronized InhibitorArc getInhibitorArc(Place p, LabelledTransition t) {
		Collection<InhibitorArc> set = getEdges(p, t, inhibitorArcs);
		return (set.isEmpty() ? null : set.iterator().next());
	}

	public synchronized ResetArc getResetArc(Place p, LabelledTransition t) {
		Collection<ResetArc> set = getEdges(p, t, resetArcs);
		return (set.isEmpty() ? null : set.iterator().next());
	}

	public synchronized LabelledTransition addTransition(String label) {
	...
	public synchronized LabelledTransition addTransition(String label, ExpandableSubNet parent) {
		LabelledTransition t = new LabelledTransition(label, this, parent);
		transitions.add(t);
		graphElementAdded(t);
		return t;
	}
	 ...
	 */
	public synchronized Arc addArc(Place p, LabelledTransition t, int weight) {
	 ...
	 */
	public synchronized Arc addArc(Place p, LabelledTransition t) {
		return addArc(p, t, 1);
	}
	 ...
	 */
	public synchronized Arc addArc(LabelledTransition t, Place p, int weight) {
	 ...
	 */
	public synchronized Arc addArc(LabelledTransition t, Place p) {
		return addArc(t, p, 1);
	}
	 ...
	 * org.processmining.models.graphbased.petrinet.Transition, int)
	 */
	public synchronized Arc addArc(Place p, LabelledTransition t, int weight, ExpandableSubNet parent) {
	 ...
	 * org.processmining.models.graphbased.petrinet.Transition)
	 */
	public synchronized Arc addArc(Place p, LabelledTransition t, ExpandableSubNet parent) {
	 ...
	 * org.processmining.models.graphbased.petrinet.Place, int)
	 */
	public synchronized Arc addArc(LabelledTransition t, Place p, int weight, ExpandableSubNet parent) {
	 ...
	 * org.processmining.models.graphbased.petrinet.Place)
	 */
	public synchronized Arc addArc(LabelledTransition t, Place p, ExpandableSubNet parent) {
	...
	public synchronized void removeNode(DirectedGraphNode node) {
		if (node instanceof LabelledTransition) {
			removeTransition((LabelledTransition) node);
	...
	public synchronized LabelledTransition removeTransition(LabelledTransition transition) {
	...
	protected synchronized Map<DirectedGraphElement, DirectedGraphElement> cloneFrom(LabelledAbstractResetInhibitorNet net,
		...
		if (resets) {
			for (ResetArc a : net.resetArcs) {
				mapping.put(a, addResetArc((Place) mapping.get(a.getSource()), (LabelledTransition) mapping.get(a.getTarget()),
						a.getLabel()));
			}
		}
	...
	public synchronized Collection<LabelledTransition> getTransitions() {
