...
public class ModifiedPnml extends PnmlElement {

	public ModifiedPnml(String tag) {
		super(tag);
	 ...
	 *
	public ModifiedPnml(PnmlType type) {
		super(TAG);
		this.type = type;
	 ...
	 *
	protected String exportElements(ModifiedPnml pnml) {
	...
	public ModifiedPnml convertFromNet(Map<LabelledPetrinetGraph, Marking> markedNets, GraphLayoutConnection layout) {
	...
	public ModifiedPnml convertFromNet(Map<LabelledPetrinetGraph, Marking> markedNets,
	...
	public ModifiedPnml convertFromNet(LabelledPetrinetGraph net, Marking marking, GraphLayoutConnection layout) {
		return convertFromNet(net, marking, new HashSet<Marking>(), layout);
	}

	public ModifiedPnml convertFromNet(LabelledPetrinetGraph net, Marking marking, Collection<Marking> finalMarkings,
			GraphLayoutConnection layout) {
	...
	public ModifiedPnml convertFromNet(LabelledPetrinetGraph net, Marking marking, Map<String, AbstractGraphElement> idMap,
			GraphLayoutConnection layout) {
