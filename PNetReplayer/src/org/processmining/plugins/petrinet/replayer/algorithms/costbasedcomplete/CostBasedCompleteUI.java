...
public class CostBasedCompleteUI extends JComponent {
	...
	protected void setupUI(Collection<Transition> transCol, Collection<XEventClass> evClassCol,
			Map<Transition, Integer> defMoveModelCost, Map<Transition, Integer> defSyncCost,
			Map<XEventClass, Integer> defMoveLogCost, SlickerFactory slickerFactoryInstance, int startAtRow) {
		// label
		int r = startAtRow;
	...
	private void populateMoveOnLogPanel(Collection<XEventClass> eventClassesName,
			Map<XEventClass, Integer> defaultCost, int row) {
