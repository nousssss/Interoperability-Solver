...
public class PNLogReplayResultVisPanel extends JPanel {
	...
	public PNLogReplayResultVisPanel() {
	}
	...
	public PNLogReplayResultVisPanel(XLog log, PNRepResult logReplayResult, Progress progress) {
	...
	private Component createBottomPanel(final XLog log, final PNRepResult logReplayResult, Progress progress) {
		// local variables
