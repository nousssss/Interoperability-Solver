...
public abstract class Manifest {
	...
	protected Map<XEventClass, Integer> moveLogCost;
	...
	public Manifest(PetrinetGraph net, Marking initMarking, Marking[] finalMarkings, XLog log, Transition[] transArr,
	...
	public void setMoveLogCost(Map<XEventClass, Integer> moveLogCost) {
		this.moveLogCost = moveLogCost;
	}
