...
public class ManifestFactory {
	...
	public static Manifest construct(PetrinetGraph net, Marking initMarking, Marking[] finalMarkings, XLog log,
			PNManifestFlattener flattener, PNRepResult pnRepResult, TransClass2PatternMap transClass2PatternMap)
			throws Exception {
		...
		casePtr = new int[logInfo.getNumberOfTraces()];
		...
		Manifest newManifest = new ManifestEvClassPattern(net, initMarking, finalMarkings, log,
