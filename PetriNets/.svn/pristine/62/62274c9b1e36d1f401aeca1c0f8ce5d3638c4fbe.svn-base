...
public class ReachabilitySetConnection extends MarkingsetNetConnection {

	public final static String INITIALMARKING = "Initial Marking";
	
	public ReachabilitySetConnection(PetrinetGraph net, Marking initial, AbstractMarkingSet<?> marking,
