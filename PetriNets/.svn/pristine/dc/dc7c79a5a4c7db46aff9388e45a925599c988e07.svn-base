...
@Plugin(name = "Import Reset/Inhibitor net from PNML file", parameterLabels = { "Filename" }, returnLabels = {
		"Reset/Inhibitor Net", "Marking" }, returnTypes = { ResetInhibitorNet.class, Marking.class })
@UIImportPlugin(description = "PNML Reset/Inhibitor net files", extensions = { "pnml" })
public class PnmlImportRINet extends AbstractImportPlugin {
