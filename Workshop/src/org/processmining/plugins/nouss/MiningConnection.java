...
import org.processmining.models.workshop.connections.AbstractWorkshopModelConnection;

/**
 * Connects an event log and a model using the parameters used.

 *
 */
public class MiningConnection extends AbstractWorkshopModelConnection<MiningParameters> {
	 ...
	 */
	public MiningConnection(XLog log, WorkshopModel model, MiningParameters parameters) {
...
/**
 * Connects an event log to a workshop model, provided the parameters used to
