 ...
 * 
 */
public class GhzMiningDialog extends JPanel {
	 ...
	 */
	public GhzMiningDialog(XLog log, final org.processmining.plugins.ghzbue.GhzMiningConfiguration configuration) {
		/*
		...
		classifierList.addListSelectionListener(new ListSelectionListener() {
			public void valueChanged(ListSelectionEvent e) {
				configuration.setClassifier((XEventClassifier) classifierList.getSelectedValue());
			}
		});
