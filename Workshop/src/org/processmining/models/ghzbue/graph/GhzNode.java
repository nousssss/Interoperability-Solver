...
/**
 * Nodes in the Ghz graph.
 * 
 * @author ghzzz
 * 
 */
public class GhzNode extends AbstractDirectedGraphNode implements Decorated {
	 ...
	 *            The given graph.
	 */
	public GhzNode(XEventClass eventClass, GhzGraph graph) {
	...
	public boolean equals(Object o) {
		return (o instanceof GhzNode ? eventClass.equals(((GhzNode) o).eventClass) : false);
	}
