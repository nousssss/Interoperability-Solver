...
public class MinerStateWithoutLog {
	public final MiningParametersWithoutLog parameters;
	private final ExecutorService minerPool;
	private final ExecutorService satPool;
	private final Canceller canceller;

	public MinerStateWithoutLog(MiningParametersWithoutLog parameters, Canceller canceller) {
